...
// @TODO: remove it when sandcastle fixes issue with timeout
//require('./patches/01.sandcastle.js');
//require('./patches/02.sandcastle.js');
//require('./patches/03.sandcastle.js');
require('./patches/04.sandcastle.js');
